...
- [`/apps/html`](https://github.com/contensis/personalization/tree/main/apps/html)
  <br> Serving static HTML with some use-case examples
- [`/apps/react`](https://github.com/contensis/personalization/tree/main/apps/react)
...
- [`/apps/react-router`](https://github.com/contensis/personalization/tree/main/apps/react-router)
