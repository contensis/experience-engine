# [![Contensis](https://github.com/contensis/cli/raw/refs/heads/main/assets/contensis-logo--tiny.svg)](https://www.contensis.com) @contensis/experience-engine [![NPM version](https://img.shields.io/npm/v/@contensis/experience-engine.svg?style=flat)](https://www.npmjs.com/package/@contensis/experience-engine)
...
```bash
npm install --save @contensis/experience-engine
```

```bash
yarn add --save @contensis/experience-engine
```
...
- set `type="module"` and load the ES module `dist/experience-engine.browser.min.mjs`
- or, load the common js script `dist/experience-engine.browser.min.js`
...
<script
  type="module"
  src="https://unpkg.com/@contensis/experience-engine@latest/dist/experience-engine.browser.min.mjs"
></script>
```
...
```
<script data-contensis-xp-alias="example" ...>
```
...
<html>
  <head>
    <script
      type="module"
      src="https://unpkg.com/@contensis/experience-engine@latest/dist/experience-engine.browser.min.mjs"
      data-contensis-xp-alias="example"
      data-contensis-xp-project-id="website"
    ></script>
    <script>
...
[Complete example](https://github.com/contensis/experience-engine/blob/main/apps/html/custom-attributes.html)
...
[Complete example](https://github.com/contensis/experience-engine/blob/main/apps/html/experiment-content.html)
